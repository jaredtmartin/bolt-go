...
func TestRect(t *testing.T) {
	...
	result := rect.Render()
	expected := `<rect height="50" width="50" x="100" y="100">`
...
func TestRectFill(t *testing.T) {
	...
	result := rect.Render()
	expected := `<rect fill="red" height="50" width="50" x="100" y="100">`
	assert.Equalf(t, expected, result, "should match")
}
...
func TestRectStroke(t *testing.T) {
	...
	result := rect.Render()
	expected := `<rect height="50" stroke="blue" width="50" x="100" y="100">`
	assert.Equalf(t, expected, result, "should match")
}
...
func TestRectStrokeWidth(t *testing.T) {
	...
	result := rect.Render()
	expected := `<rect height="50" stroke-width="2" stroke="blue" width="50" x="100" y="100">`
	assert.Equalf(t, expected, result, "should match")
}
...
func TestRectOpacity(t *testing.T) {
	...
	result := rect.Render()
	expected := `<rect height="50" opacity="0.5" width="50" x="100" y="100">`
	assert.Equalf(t, expected, result, "should match")
}
...
func TestRectFillOpacity(t *testing.T) {
	...
	result := rect.Render()
	expected := `<rect fill-opacity="0.5" height="50" width="50" x="100" y="100">`
	assert.Equalf(t, expected, result, "should match")
}
...
func TestRectStrokeOpacity(t *testing.T) {
	...
	result := rect.Render()
	expected := `<rect height="50" stroke-opacity="0.5" width="50" x="100" y="100">`
	assert.Equalf(t, expected, result, "should match")
}
...
func TestRectFilter(t *testing.T) {
	...
	result := rect.Render()
	expected := `<rect filter="url(#filter)" height="50" width="50" x="100" y="100">`
	assert.Equalf(t, expected, result, "should match")
}
...
func TestRectTransform(t *testing.T) {
	...
	result := rect.Render()
	expected := `<rect height="50" transform="translate(10, 10)" width="50" x="100" y="100">`
	assert.Equalf(t, expected, result, "should match")
}
...
func TestRectClipPath(t *testing.T) {
	...
	result := rect.Render()
	expected := `<rect clip-path="url(#clipPath)" height="50" width="50" x="100" y="100">`
	assert.Equalf(t, expected, result, "should match")
}
...
func TestRectStrokeDasharray(t *testing.T) {
	...
	result := rect.Render()
	expected := `<rect height="50" stroke-dasharray="5, 5" width="50" x="100" y="100">`
	assert.Equalf(t, expected, result, "should match")
}
...
func TestRectStrokeLinecap(t *testing.T) {
	...
	result := rect.Render()
	expected := `<rect height="50" stroke-linecap="round" width="50" x="100" y="100">`
	assert.Equalf(t, expected, result, "should match")
}
...
func TestRectStrokeLinejoin(t *testing.T) {
	...
	result := rect.Render()
	expected := `<rect height="50" stroke-linejoin="round" width="50" x="100" y="100">`
	assert.Equalf(t, expected, result, "should match")
}
...
func TestRectStrokeMiterlimit(t *testing.T) {
	...
	result := rect.Render()
	expected := `<rect height="50" stroke-miterlimit="2" width="50" x="100" y="100">`
	assert.Equalf(t, expected, result, "should match")
}
