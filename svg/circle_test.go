...
func TestCircle(t *testing.T) {
	...
	expected := `<circle cx="100" cy="100" r="50">`
...
func TestCircleFill(t *testing.T) {
	...
	result := circle.Render()
	expected := `<circle cx="100" cy="100" fill="red" r="50">`
	assert.Equalf(t, expected, result, "should match")
}
...
func TestCircleStroke(t *testing.T) {
	...
	result := circle.Render()
	expected := `<circle cx="100" cy="100" r="50" stroke="blue">`
	assert.Equalf(t, expected, result, "should match")
}
...
func TestCircleStrokeWidth(t *testing.T) {
	...
	result := circle.Render()
	expected := `<circle cx="100" cy="100" r="50" stroke-width="2" stroke="blue">`
	assert.Equalf(t, expected, result, "should match")
}
...
func TestCircleOpacity(t *testing.T) {
	...
	result := circle.Render()
	expected := `<circle cx="100" cy="100" opacity="0.5" r="50">`
	assert.Equalf(t, expected, result, "should match")
}
...
func TestCircleFillOpacity(t *testing.T) {
	...
	result := circle.Render()
	expected := `<circle cx="100" cy="100" fill-opacity="0.5" r="50">`
	assert.Equalf(t, expected, result, "should match")
}
...
func TestCircleStrokeOpacity(t *testing.T) {
	...
	result := circle.Render()
	expected := `<circle cx="100" cy="100" r="50" stroke-opacity="0.5">`
	assert.Equalf(t, expected, result, "should match")
}
...
func TestCircleFilter(t *testing.T) {
	...
	result := circle.Render()
	expected := `<circle cx="100" cy="100" filter="url(#filter)" r="50">`
	assert.Equalf(t, expected, result, "should match")
}
...
func TestCircleStrokeDasharray(t *testing.T) {
	...
	result := circle.Render()
	expected := `<circle cx="100" cy="100" r="50" stroke-dasharray="5, 5">`
	assert.Equalf(t, expected, result, "should match")
}
...
func TestCircleStrokeLinecap(t *testing.T) {
	...
	result := circle.Render()
	expected := `<circle cx="100" cy="100" r="50" stroke-linecap="round">`
	assert.Equalf(t, expected, result, "should match")
}
