...
func TestLine(t *testing.T) {
	...
	result := line.Render()
	expected := `<line x1="100" x2="200" y1="100" y2="200">`
...
func TestLineStroke(t *testing.T) {
	...
	result := line.Render()
	expected := `<line stroke="red" x1="100" x2="200" y1="100" y2="200">`
	assert.Equalf(t, expected, result, "should match")
}
...
func TestLineStrokeWidth(t *testing.T) {
	...
	result := line.Render()
	expected := `<line stroke-width="2" stroke="red" x1="100" x2="200" y1="100" y2="200">`
	assert.Equalf(t, expected, result, "should match")
}
...
func TestLineOpacity(t *testing.T) {
	...
	result := line.Render()
	expected := `<line opacity="0.5" x1="100" x2="200" y1="100" y2="200">`
	assert.Equalf(t, expected, result, "should match")
}
...
func TestLineFill(t *testing.T) {
	...
	result := line.Render()
	expected := `<line fill="blue" x1="100" x2="200" y1="100" y2="200">`
	assert.Equalf(t, expected, result, "should match")
}
...
func TestLineFillOpacity(t *testing.T) {
	...
	result := line.Render()
	expected := `<line fill-opacity="0.5" fill="blue" x1="100" x2="200" y1="100" y2="200">`
	assert.Equalf(t, expected, result, "should match")
}
...
func TestLineStrokeDasharray(t *testing.T) {
	...
	result := line.Render()
	expected := `<line stroke-dasharray="10,5" stroke="red" x1="100" x2="200" y1="100" y2="200">`
	assert.Equalf(t, expected, result, "should match")
}
...
func TestLineStrokeDashoffset(t *testing.T) {
	...
	result := line.Render()
	expected := `<line stroke-dashoffset="10" stroke="red" x1="100" x2="200" y1="100" y2="200">`
	assert.Equalf(t, expected, result, "should match")
}
...
func TestLineStrokeLinecap(t *testing.T) {
	...
	result := line.Render()
	expected := `<line stroke-linecap="round" stroke="red" x1="100" x2="200" y1="100" y2="200">`
	assert.Equalf(t, expected, result, "should match")
}
